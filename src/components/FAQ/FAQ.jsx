...
const FAQ = ({ blockRef4 }) => {
    ...
    return (
        <div className={style.faq} ref={blockRef4}>
            ...
            <div className={style.item} onClick={() => setSecondOpen((secondOpen) => !secondOpen)}>
                <div className={style.wrapp}>
            ...
            <div className={style.item} onClick={() => setThirdOpen((thirdOpen) => !thirdOpen)}>
                <div className={style.wrapp}>
            ...
            <div className={style.item} onClick={() => setFourthOpen((fouthOpen) => !fouthOpen)}>
                <div className={style.wrapp}>
